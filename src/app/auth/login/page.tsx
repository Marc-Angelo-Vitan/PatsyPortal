...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // This is a simulation - replace with your real auth logic
      await new Promise(resolve => setTimeout(resolve, 1500));
      
      // Demo credentials check
      if (email === 'admin@patsycoffee.com' && password === 'password123') {
        ...
        <div className="max-w-6xl w-full flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-lg lg:text-xl mb-6 text-gray-200 drop-shadow-md">
              Welcome back to your coffee management portal
            </p>
            ...
            <div className="hidden lg:block bg-black/20 backdrop-blur-sm rounded-xl p-6">
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div className="flex items-center gap-2 text-white">
                  <span className="text-green-400">✓</span> Product Management
                </div>
                <div className="flex items-center gap-2 text-white">
                  <span className="text-green-400">✓</span> Inventory Tracking
                </div>
                <div className="flex items-center gap-2 text-white">
                  <span className="text-green-400">✓</span> Sales Reports
                </div>
                <div className="flex items-center gap-2 text-white">
                  <span className="text-green-400">✓</span> Transaction History
                </div>
                <div className="flex items-center gap-2 text-white">
              ...
              <div className="p-6 sm:p-8 md:p-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="flex items-center justify-between">
                    <label className="flex items-center cursor-pointer">
                      <input 
                        type="checkbox" 
                        disabled={isLoading}
                        className="rounded focus:ring-0 cursor-pointer disabled:opacity-50"
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full text-white font-semibold py-3 rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed hover:opacity-90 relative"
                ...
                <div className="bg-gray-50 rounded-lg p-4 mb-6">
                  <div className="text-center text-sm space-y-2">
                    <p className="text-gray-700 font-medium">Use these credentials to test:</p>
                    <div className="flex flex-col sm:flex-row gap-2 justify-center">
                      <code className="bg-white px-3 py-1.5 rounded-md border border-gray-200 text-gray-700 text-xs">
                        admin@patsycoffee.com
                      </code>
                      <code className="bg-white px-3 py-1.5 rounded-md border border-gray-200 text-gray-700 text-xs">
                        password123
                      </code>
